...
const svgHeartFill = (<svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
  <g clip-path="url(#clip0_855_375)">
    <path fill-rule="evenodd" clip-rule="evenodd" d="M8 1.31405C12.438 -3.24795 23.534 4.73505 8 15.0001C-7.534 4.73605 3.562 -3.24795 8 1.31405Z" fill="#F4D3A1" />
  </g>
  <defs>
      ...
      <div className="likes_container">
        <form name="like_form" onSubmit={handleLikeSubmit}>
          <button type="submit" className="btn">
            {place.Likes.some((like) => like.userId === user.id)
              ? svgHeartFill
              : svgHeart}
          </button>
        </form>
