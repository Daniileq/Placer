...
function UserSettingsPage() {
  ...
  const [secondPasswordVisibility, setSecondPasswordVisibility] = useState(false);
  ...
  const toggleFirstPassword = () => {
    setFirstPasswordVisibility((prev) => !prev);
  };

  const toggleSecondPassword = () => {
    setSecondPasswordVisibility((prev) => !prev);
  };
        ...
        <div className="profile">
          <div className="user_info">
            <div className="change_photo_container">
              <div className="user_photo_wrapper_change">
          ...
          <div className="user_data">
            <form onSubmit={settingsSubmit} className="user_settings_form">
              ...
              <div className="field">
                <label htmlFor="ageInput">Возраст:</label>
                <input
                  type="number"
                  min={1}
                  max={120}
            ...
            <form onSubmit={changePassSubmit} className="user_pass_form">
              ...
              <div className="field">
                ...
                <input
                  type={firstPasswordVisibility ? 'text' : 'password'}
                  name="password"
                  id="passwordInput"
                ...
                />
                <button type='button' onClick={toggleFirstPassword} className="change_pass_btn">
                  {firstPasswordVisibility ? <AiOutlineEye /> : <AiOutlineEyeInvisible />}
                </button>
              </div>
              ...
              <div className="field">
                ...
                <input
                  type={secondPasswordVisibility ? 'text' : 'password'}
                  name="repeatPass"
                  id="repeatPassInput"
                  placeholder="Повторите пароль"
                />
                <button type='button' onClick={toggleSecondPassword} className="change_pass_btn">
                  {secondPasswordVisibility ? <AiOutlineEye /> : <AiOutlineEyeInvisible />}
                </button>
              </div>
