...
const manWalk = (<svg width="23" height="31" viewBox="0 0 23 31" fill="none" xmlns="http://www.w3.org/2000/svg">
  <path d="M6 21.5001L8.5 10.5001L6.5 11.5001L5.5 16.0001C5.33333 16.1667 4.8 16.5 4 16.5C3.2 16.5 3 15.8333 3 15.5L4.5 10C6.33333 8.83336 10.3 6.40007 11.5 6.00007C12.7 5.60007 14 6.50007 14.5 7.00007C15.5 9 16.5 10.5001 17 11.5001L21 14.0001C21 15.0001 21.5 16.0001 19.5 16.0001C17.9 16.0001 16.1667 14.3334 15.5 13.5001L14 11.0001L13 16.0001L18 21.5001L19 29.0001C19 29.1667 18.7 29.6001 17.5 30.0001C16.3 30.4001 15.6667 29.5001 15.5 29.0001L14 23.0001L10 19.0001L9 23.5001L5 29.5001C4.5 29.8334 3.3 30.3001 2.5 29.5001C1.7 28.7001 1.83333 27.8334 2 27.5001L6 21.5001Z" stroke="#F4D3A1" />
  <circle cx="12.5" cy="2.5" r="2" stroke="#F4D3A1" />
</svg>
);

const manWalkFill = (<svg width="23" height="32" viewBox="0 0 23 32" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <circle cx="12.5" cy="3.5" r="2.5" fill="#F4D3A1" />
</svg>
);
...
function PlaceToGoButton({ place }) {
  ...
  return (
    <div className='place_to_go_container'>
      <form action="#" className='place_to_go_form' onSubmit={handlePlaceToGoSubmit}>
        ...
        <div className='font_caption' style={{ lineHeight: '38px' }}>
